...
import 'package:krash_company/home/myorder.dart';
...
class _HomeScreen extends State<StatefulWidget>
{
  ...
  Widget getAboutMe()
  {
    ...
    _username.text = data['name'].toString();
    _emailaddress.text = data['mail'].toString();
    return Container(
      width: MediaQuery.of(context).size.width,
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(width: 2,color: Color.fromRGBO(0, 0, 102, 1)),
                    ...
                    onPressed: (){
                      if(_form_Key.currentState.validate())
                      {
                        FirebaseFirestore.instance.collection("users").doc(data['userid'])
                          ...
                          'mail': _emailaddress.text.toString(),
                        }).then((value){
                          print('updated');
                          Navigator.pop(context);

                          data['name'] = _username.text.toString();
                          data['mail'] = _emailaddress.text.toString();
  ...
  Widget getOrdersList(Map servicedata)
  {
    return Container(
      width: MediaQuery.of(context).size.width,
      margin: EdgeInsets.fromLTRB(0, 5, 0, 5),
      ...
      child: ListTile(
        ...
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (context) => MyOrder(data,servicedata)));
        },
  ...
  GlobalKey<FormState> _form_Key = new GlobalKey<FormState>();
