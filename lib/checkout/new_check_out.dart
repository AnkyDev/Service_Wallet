...
import 'package:krash_company/checkout/payment.dart';
...
class _CheckOut extends State<CheckOut>{
  ...
  void paySucess(PaymentSuccessResponse response)
  {
    ...
    placeOrder(response.paymentId.toString());
      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            _pointer == true ? Center(child: CircularProgressIndicator()) : getContainerForPrice(),
          ],
        ),
        appBar: AppBar(
          title: Text(
                  ...
                  child: Container(
                      ...
                      child: MaterialButton(
                        onPressed: (){
                          ...
                          //   MaterialPageRoute(builder: (context) => Payment((10+total).toString())),
                          // );
  ...
  void placeOrder(String paymentid)
  {
    setState(() {
      _pointer = true;
    });
    String orderid = Uuid().v1().toString() ;
    String userid = user_data['userid'];
    ...
    oc.placeOrder(orderid, userid, mobileno, address, lat, log, servicename,cartype, price, ontime, ondate, status, takenbyid, time, date,paymentid).then((value){
